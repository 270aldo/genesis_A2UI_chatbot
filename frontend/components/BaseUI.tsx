...
export const GlassInput: React.FC<GlassInputProps> = (props) => (
  <input 
    {...props}
    className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#6D00FF]/50 transition-all placeholder:text-white/20"
  />
);
...
export const GlassSlider: React.FC<GlassSliderProps> = ({ value, min, max, onChange, label }) => (
  <div className="w-full">
    <div className="flex justify-between mb-2">
      {label && <span className="text-[10px] text-white/50 uppercase font-bold">{label}</span>}
    ...
    <input 
      ...
      className="w-full h-1 bg-white/10 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[#6D00FF]"
    />
  </div>
);